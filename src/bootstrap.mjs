...
function patchOpenClawJson() {
  ...
  const DESIRED_MODELS = {
    ...
    "venice/hermes-3-llama-3.1-405b": { alias: "Hermes 3 Llama 405B (Venice)" },
    ...
    "venice/nvidia-nemotron-3-nano-30b-a3b": { alias: "Nemotron 3 Nano (Venice)" },
    ...
    "venice/qwen3-coder-480b-a35b-instruct-turbo": { alias: "Qwen3 Coder Turbo (Venice)" },
    ...
    "venice/olafangensan-glm-4.7-flash-heretic": { alias: "GLM 4.7 Heretic (Venice)" },
    // ── MiniMax ──
