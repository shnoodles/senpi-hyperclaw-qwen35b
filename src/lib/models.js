...
export const DESIRED_MODELS = {
  ...
  "senpi-qwen-35b/qwen3.5-35b": { alias: "Qwen3.5 35B A3B (Senpi Vertex, MoE)" },
  "senpi-gemma-4/gemma-4-31b-it": { alias: "Gemma 4 31B IT (Senpi Vertex)" },
};
...
export const PROVIDER_DEFAULTS = [
  ...
  { key: "SENPI_QWEN_35B_API_KEY", model: "senpi-qwen-35b/qwen3.5-35b" },
  { key: "SENPI_GEMMA_4_API_KEY", model: "senpi-gemma-4/gemma-4-31b-it" },
];
...
export const AI_PROVIDER_MODEL_MAP = {
  ...
  "senpi-qwen-35b": "senpi-qwen-35b/qwen3.5-35b",
  "senpi-gemma-4": "senpi-gemma-4/gemma-4-31b-it",
};
