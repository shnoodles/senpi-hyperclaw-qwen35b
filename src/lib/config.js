...
export const PROVIDER_BASE_URL = {
  ...
  "senpi-qwen-35b": process.env.SENPI_QWEN_35B_BASE_URL || "https://qwen35b-production.up.railway.app/v1",
...
const PROVIDER_API_KEY_ENV = {
  ...
  "senpi-qwen-35b": "SENPI_QWEN_35B_API_KEY",
